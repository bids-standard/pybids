...
def _make_passthrough_contrast(level, model_type='glm', test='t'):
    gb_dict = dict(  # noqa: C408
        Subject=['subject', 'contrast'], Session=['session', 'contrast'], Dataset=['contrast']
    )
    block = dict(  # noqa: C408
        Level=level,
        Name=level,
...
def auto_model(layout, scan_length=None, one_vs_rest=False):
    ...
    for task_name in tasks:
        ...
        model['Description'] = 'Autogenerated model for the %s task from %s' % (  # noqa: UP031
            task_name,
            base_name,
        )
        ...
        transformations = dict(  # noqa: C408
            Transformer='pybids-transforms-v1',
            Instructions=[dict(Name='Factor', Input='trial_type')],  # noqa: C408
        )
        run = dict(  # noqa: C408
            Level='Run', Name='Run', GroupBy=['run', 'subject'], Transformations=transformations
        )
        ...
        # Add HRF
        run_model['HRF'] = dict(  # noqa: C408
            Variables=trial_type_factors,
            Model='DoubleGamma',
            Parameters=dict(  # noqa: C408
                PeakDelay=3,
                PeakDispersion=6,
                UndershootDelay=10,
