...
def node_report(node_output):
    ...
    try:
        ...
        _report['design_matrix_plot'] = plot_design_matrix(node_output.X, timecourse=True)
...
def get_all_contrast_vif(node_output):  # noqa: D417
    ...
    """
    vif_contrasts = {'contrast': [], 'VIF': []}

    con_matrix = generate_contrast_matrix(node_output.contrasts, node_output.X.columns)
