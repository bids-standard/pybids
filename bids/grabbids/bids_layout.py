...
class BIDSLayout(Layout):
    ...
    def get_bvec(self, path, **kwargs):
        return self.get_nearest_helper(path, 'bvec', type='dwi', return_list=False, **kwargs)

    def get_bval(self, path, **kwargs):
        return self.get_nearest_helper(path, 'bval', type='dwi', return_list=False, **kwargs)

    def get_events(self, path, **kwargs):
        return self.get_nearest_helper(path, '.tsv', type='events', return_list=False, **kwargs)
