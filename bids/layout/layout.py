...
class BIDSLayout(object):
    ...
    def add_derivatives(self, path, create_derivative_database_files=False, **kwargs):
        ...
        Args:
            ...
            create_derivative_database_files (bool) : If True, use the pipline
                name from the dataset_description.json file as the database filename
                and write the file to disk in the derivatives directory.
